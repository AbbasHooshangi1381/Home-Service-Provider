...
public class Menu {
    ...
    public Menu() throws Exception {
        ...
        public void registerFromConsole () throws Exception {
...

              {
                    ...
                    switch (select) {
                        case 1:
                            ...
                            System.out.println("menShoes");
                            System.out.println("womenShoes");
                        ...
                        case 2:
                           ...
                           // cartRepository.save(productsEn);
                            cartService.save(new Cart( product.getId() , 1 , 1 ));
                        ...
                        case 6:
                            System.out.println("bye without hand...");
                    }
                }
            }
        }
